...
<section class="ae a2d a2U a2V a2W a2X dark:a2Y[#3c3e56] dark:a2Z a1M wow fadeInUp" data-wow-delay=".2s">
  <div class="ab">
    <div class="aJ[570px] a2f a2g">
      ...
      <ul class="a6 a7 a1p">
        <li class="a6 a7">
          <a href="/" class="a25 aR aT hover:aU">
            Home
          </a>
  ...
  <div class="ao a9 a1a a16 a2f a2i">
    <svg class="a5 a1P" viewBox="0 0 1440 300" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g mask="url(#mask0_109_1705)">
        <path opacity="0.7" d="M1291.06 -3.15679C1175.26 243.544 983.032 314.788 901.395 319.573L872 460.514L1562.33 604.489L1702.1 -65.7031C1613.34 -147.646 1406.86 -249.858 1291.06 -3.15679Z" fill="url(#paint1_linear_109_1705)" />
        <path opacity="0.5" d="M1222.49 9.45347C1172.63 310.802 986.959 446.139 900.353 476.139L911.528 637.115L1699.98 582.38L1646.84 -183.078C1526.17 -244.463 1272.34 -291.895 1222.49 9.45347Z" fill="url(#paint2_linear_109_1705)" />
        <path opacity="0.7" d="M149.358 308.718C222.688 88.7382 378.04 9.42554 446.549 -2.73335L457.377 -124.754L-140.275 -177.786L-191.761 402.434C-108.609 462.853 76.0275 528.697 149.358 308.718Z" fill="url(#paint3_linear_109_1705)" />
        <path opacity="0.5" d="M240.436 277.93C254.739 -27.18 423.33 -183.285 505.837 -223.198L475.93 -381.766L-300.729 -235.281L-158.516 518.725C-31.4918 565.589 226.133 583.039 240.436 277.93Z" fill="url(#paint4_linear_109_1705)" />
      </g>
      <defs>
  ...
  <div class="ab">
    ...
    @foreach ($blogs->skip(0) as $blog)
      <div class="a5 lg:a2u/2 af">
        <div class="aA[350px] ae a1M a1N a1O wow fadeInUp" data-wow-delay=".2s">
            @if ($blog->image)
                <img src="{{ asset('storage/' . $blog->image) }}"
                            alt="{{ $blog->category->name }}" class="a5 a1P a1Q a1R">
            @else
          ...
          <div class="ao a5 a1P a9 a1a a6 a1S a1T a1U a1V">
            <div class="a1W a5 a33 a6 a1S ad">
              <div class="aJ[410px] w-full">
                <h3>
                  <h5 class="a1X a1Y a1k hover:aU a1Z al"><a href="/blogs/{{$blog->slug}}">{{$blog->title}}</a></h5>
                </h3>
                
                <small class="text-slate-50" >
                 By. <a href="/authors/{{ $blog->author->username }}">{{ $blog->author->name }}</a>  {{ $blog->created_at->diffForHumans() }}
                </small>
              ...
              <div class="a6 a7 ad">
                <a href="/blogs/{{$blog->slug}}" class="a1k hover:aU" name="read-more" aria-label="read-more">
                  <svg width="32" height="32" viewBox="0 0 32 32" class="a23">
                    <path d="M18.6667 22.5868V17.2534H6.77334L6.73334 14.5734H18.6667V9.25342L25.3333 15.9201L18.6667 22.5868Z" />
                  </svg>
                </a>
              </div>
            </div>
...
<footer id="footer">
  ...
  <div class="mt-20 bg-teal-500  a2H wow fadeInUp" data-wow-delay=".25s">
