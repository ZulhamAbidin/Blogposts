...
<body>
        ...
        <div class="hidden md:text-sm lg:text-base md:col-span-3 md:flex md:justify-start">
          ...
          <form action="/logout" method="post" class="ml-40"> @csrf
            <button type="submit" class="py-5 px-4 font-inter flex">Log Out
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mt-0,5 ml-2" fill="none" viewBox="0 0 24 24"
          ...
          <a href="/login" class="py-5 px-4 font-inter {{ $judul === 'Login' ? 'active' : '' }}"><i
              class="bi bi-box-arrow-in-right"></i> Login</a> @endauth
        </div>
  ...
  <section class="ae a2d a2U a2V a2W a2X dark:a2Y[#3c3e56] dark:a2Z a1M wow fadeInUp" data-wow-delay=".2s">
    <div class="ab">
      <div class="aJ[570px] a2f a2g">
        ...
        <ul class="a6 a7 a1p">
          ...
          <li class="a6 a7">
            <a href="/blogs" class="a25 aR aT hover:aU">
              Postingan
            </a>
          </li>
        </ul>
    ...
    <div class="ao a9 a1a a16 a2f a2i">
      <svg class="a5 a1P" viewBox="0 0 1440 300" fill="none" xmlns="http://www.w3.org/2000/svg">
        <mask id="mask0_109_1705" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="1440"
          height="300">
          <rect width="1440" height="300" fill="url(#paint0_linear_109_1705)" />
        </mask>
        ...
        <defs>
          <linearGradient id="paint0_linear_109_1705" x1="1440" y1="149.664" x2="-32.6283" y2="149.664"
            gradientUnits="userSpaceOnUse">
            <stop stop-color="#E4F2FE" />
            <stop offset="1" stop-color="#FFEEFE" />
          </linearGradient>
          <linearGradient id="paint1_linear_109_1705" x1="995.731" y1="-66.5516" x2="1096.08" y2="471.23"
            gradientUnits="userSpaceOnUse">
            <stop stop-color="white" />
            <stop offset="1" stop-color="white" stop-opacity="0" />
          </linearGradient>
          <linearGradient id="paint2_linear_109_1705" x1="884.631" y1="30.9273" x2="1156.5" y2="580.496"
            gradientUnits="userSpaceOnUse">
            <stop stop-color="white" />
            <stop offset="1" stop-color="white" stop-opacity="0" />
          </linearGradient>
          <linearGradient id="paint3_linear_109_1705" x1="405.219" y1="332.927" x2="266.963" y2="-111.532"
            gradientUnits="userSpaceOnUse">
            <stop stop-color="white" />
            <stop offset="1" stop-color="white" stop-opacity="0" />
          </linearGradient>
          <linearGradient id="paint4_linear_109_1705" x1="573.471" y1="217.127" x2="239.254" y2="-296.913"
            gradientUnits="userSpaceOnUse">
            <stop stop-color="white" />
            <stop offset="1" stop-color="white" stop-opacity="0" />
          </linearGradient>
  ...
  <section>
    ...
    <div class="swiper w-full p-4 bg-white md:max-w-xl mt-14">
      <!-- Additional required wrapper -->
      <div class="swiper-wrapper">
        <!-- Slides -->
        <div class="swiper-slide"> <img class="object-center object-cover rounded-xl"
            src="https://zulhamabidin.github.io/source/img/long8.JPG" alt=""> </div>
        {{-- <div class="swiper-slide"> <img class="object-center object-cover rounded-xl"
            src="https://zulhamabidin.github.io/source/img/long7.jpg" alt=""> </div> --}}
        <div class="swiper-slide"> <img class="object-center object-cover rounded-xl"
            src="https://zulhamabidin.github.io/source/img/long9.JPG" alt=""> </div>
        <div class="swiper-slide"> <img class="object-center object-cover rounded-xl"
            src="https://zulhamabidin.github.io/source/img/long5.jpg" alt=""> </div>
        ...
      </div>
    ...
    <div class="ab">
      <div class="a6 a1K ac">
        ...
        @foreach ($blogs->skip(1) as $blog)
            ...
            @if ($blog->image)
            <img src="{{ asset('storage/' . $blog->image) }}" alt="{{ $blog->category->name }}" class="a5 a1P a1Q a1R">
            @else
  
            <img src="http://source.unsplash.com/500x400?{{ $blog->category->name }}" class="card-img-top"
              alt="{{ $blog->category->name }}">
  
            @endif
  
          
                  <small class="text-slate-50">
                    By. <a href="/authors/{{ $blog->author->username }}">{{ $blog->author->name }}</a> {{
                    $blog->created_at->diffForHumans() }}
                  </small>
  
                  <p class="a25 aR a1k">{{ $blog->excerpt }}</p>
  
                <
                  <a href="/blogs/{{$blog->slug}}" class="a1k hover:aU" name="read-more" aria-label="read-more">
  ...
  <footer id="footer">
    ...
    <div class="mt-64 bg-teal-500  a2H wow fadeInUp" data-wow-delay=".25s">
      <p class="text-slate-50 a25 aR aT a2g">
