        ...
        <div
            ...
            <div class="flex flex-col justify-between">
                <div>
                    ...
                    <a href="https://www.instagram.com/zlhm.a/?hl=id "
                        class="mt-4 flex w-56 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  text-white font-bold py-2 px-4 rounded">
