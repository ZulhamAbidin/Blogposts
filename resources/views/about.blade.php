      ...
      <div
        ...
        <div class="flex flex-col justify-between">
          <div>
            ...
            <a href="https://www.instagram.com/zlhm.a/?hl=id " class="mt-4 flex w-56 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  text-white font-bold py-2 px-4 rounded">
        ...
        <div class="">
          ...
          <div class="mt-8">
            <button
              class="uppercase text-sm font-bold tracking-wide bg-teal-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
              Send Message
            </button>
          </div>
        </div>
