            ...
            <form action="/dashboard/blogs/{{ $blog->slug }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 grid grid-cols-2 mt-12">
                    ...
                    <input type="input"
                        ...
                        name="title" autofocus value="{{ old('title', $blog->title) }}" autocomplete="off"
                        required>
                ...
                <div class="mb-3">
                    ...
                    @if ($blog->image)
                        <img src="{{ asset('storage/' . $blog->image) }}" alt=""
                            class="img-preview img-fluid mb-3 col-sm-5 d-block max-w-md">
                    @else
                ...
                <button type="submit"
                    class="p-2 bg-[#1E40AF] text-slate-50 px-4 rounded-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-240  duration-300">Create
                    blog</button>
                <a href="/dashboard/blogs/{{ $blog->slug }}"
                    class="p-[9px] bg-[#1E40AF] text-slate-50 px-10 rounded-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-240  duration-300">Cancel</a>
            </form>
