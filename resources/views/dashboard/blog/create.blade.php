...
<div class="content">
  ...
  <form action="/dashboard/blogs" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit" class="p-2 bg-teal-500 text-slate-50 px-4 rounded-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-240  duration-300">Create blog</button>
            <a href="/dashboard/blogs" class="p-[9px] bg-teal-500 text-slate-50 px-10 rounded-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-240  duration-300">Cancel</a>
        </form>
