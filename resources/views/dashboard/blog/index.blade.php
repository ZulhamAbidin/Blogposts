        ...
        <div class="content">
            ...
            <div class="grid grid-cols-12 gap-2">
                ...
                <div
                    ...
                    <a href="/dashboard/blogs/create" class="btn bg-teal-500 text-slate-50 mb-3 mt-4">Create new
                        blog</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="flex gap-4">
                                                        <a href="/dashboard/blogs/{{ $blog->slug }}"
                                                            class="badge"><svg xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <form action="/dashboard/blogs/{{ $blog->slug }}"
                                                            ...
                                                            <button class="badge border-0"
                                                                onclick="return confirm('Are you sure ?')"> <svg
                                                                    ...
                                                                    class="h-6 w-6 text-danger" fill="none"
                                                                    viewBox="0 0 24 24" stroke="currentColor"
                                                                    stroke-width="2">
