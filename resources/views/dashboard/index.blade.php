  ...
  <div class="flex mt-[4.7rem] md:mt-0">
      ...
      <div class="content">
        <div class="top-bar">
          ...
          <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
            <ol class="breadcrumb">
              <li class="breadcrumb-item active  font-semibold" aria-current="page">Dashboard</li>
            </ol>
          </nav>
      ...
      <div class="grid grid-cols-12 gap-6 mt-8">
        ...
        <div class="intro-y inbox box mt-5">
          ...
          <div class="intro-y">
            <div class="rounded-lg drop-shadow-2xl inbox__item inbox__item--active inline-block sm:block text-slate-600 dark:text-sky-500 bg-slate-100 dark:bg-darkmode-400/70 border-b border-slate-200/60 dark:border-darkmode-400">
